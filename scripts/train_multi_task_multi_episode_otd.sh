...
#export gem, verl, rllm pkgs
export PYTHONPATH="$(pwd)/third_party/verl${PYTHONPATH:+:$PYTHONPATH}:$(pwd)/third_party/rllm:$(pwd)/third_party/gem"
...
python scripts/train_multi_episode.py \
    ...
    algorithm.adv_estimator=tir_optimal_token_baseline \
