...
STRIP_SYSTEM_FROM_TEACHER_PROMPT=${STRIP_SYSTEM_FROM_TEACHER_PROMPT:-True}
MERGE_TO_ADVANTAGES=${MERGE_TO_ADVANTAGES:-False}
...
python scripts/train_multi_episode.py \
    ...
    +rllm.distill.strip_system_from_teacher_prompt=$STRIP_SYSTEM_FROM_TEACHER_PROMPT \
    +rllm.distill.merge_to_advantages=$MERGE_TO_ADVANTAGES \
